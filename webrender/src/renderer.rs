...
use glyph_renderer::{self, GlyphRenderer};
...
fn create_prim_shader(
    ...
    let vertex_descriptor = match vertex_format {
        ...
        VertexArrayKind::VectorStencil => glyph_renderer::DESC_VECTOR_STENCIL,
        VertexArrayKind::VectorCover => glyph_renderer::DESC_VECTOR_COVER,
    };
...
impl Renderer {
    ...
    pub fn draw_instanced_batch<T>(
        ...
        let vao = match vertex_array_kind {
            ...
            VertexArrayKind::VectorStencil => &self.glyph_renderer.vector_stencil_vao,
            VertexArrayKind::VectorCover => &self.glyph_renderer.vector_cover_vao,
        };
